...
for seed in $(seq 1 5); do
    python structural_probes/run_experiment.py \
        config/cumulative_gpt2medium/18.yaml \
        --train-probe \
        --seed $seed \
        --corpus_root data \
        ...
        --embeddings_train_path wikitext103_single_clause_0.1_50K_fixed/train.gpt2medium \
        --embeddings_dev_path wikitext103_single_clause_0.1_50K_fixed/dev.gpt2medium \
        --embeddings_test_path wikitext103_single_clause_0.1_50K_fixed/test.gpt2medium \
        --output_dir results/wikitext103_single_clause_0.1_50K_fixed_cumulative_gpt2medium
done
